...
extern PROTOBUF_INTERNAL_EXPORT_zss_5fdebug_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Rectangle_zss_zss_5fdebug_2eproto;
class PointDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Point> _instance;
} _Point_default_instance_;
class Rectangle_zssDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<Rectangle_zss> _instance;
} _Rectangle_zss_default_instance_;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Debug_Arc_zss_5fdebug_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsscc_info_Debug_Arc_zss_5fdebug_2eproto}, {
      &scc_info_Rectangle_zss_zss_5fdebug_2eproto.base,}};
...
static void InitDefaultsscc_info_Rectangle_zss_zss_5fdebug_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::_Rectangle_zss_default_instance_;
    new (ptr) ::Rectangle_zss();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::Rectangle_zss::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Rectangle_zss_zss_5fdebug_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsscc_info_Rectangle_zss_zss_5fdebug_2eproto}, {
      &scc_info_Point_zss_5fdebug_2eproto.base,}};
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_zss_5fdebug_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  0,
  1,
  PROTOBUF_FIELD_OFFSET(::Rectangle_zss, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::Rectangle_zss, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::Rectangle_zss, point1_),
  PROTOBUF_FIELD_OFFSET(::Rectangle_zss, point2_),
  0,
  1,
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::_Rectangle_zss_default_instance_),
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_zss_5fdebug_2eproto = {
  &descriptor_table_zss_5fdebug_2eproto_initialized, descriptor_table_protodef_zss_5fdebug_2eproto, "zss_debug.proto", 1276,
...
void Rectangle_zss::InitAsDefaultInstance() {
  ::_Rectangle_zss_default_instance_._instance.get_mutable()->point1_ = const_cast< ::Point*>(
      ::Point::internal_default_instance());
  ::_Rectangle_zss_default_instance_._instance.get_mutable()->point2_ = const_cast< ::Point*>(
      ::Point::internal_default_instance());
}
class Rectangle_zss::_Internal {
 public:
  using HasBits = decltype(std::declval<Rectangle_zss>()._has_bits_);
  static const ::Point& point1(const Rectangle_zss* msg);
  static void set_has_point1(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static const ::Point& point2(const Rectangle_zss* msg);
...
const ::Point&
Rectangle_zss::_Internal::point1(const Rectangle_zss* msg) {
  return *msg->point1_;
}
const ::Point&
Rectangle_zss::_Internal::point2(const Rectangle_zss* msg) {
  return *msg->point2_;
}
Rectangle_zss::Rectangle_zss()
  : ::PROTOBUF_NAMESPACE_ID::Message(), _internal_metadata_(nullptr) {
  SharedCtor();
  // @@protoc_insertion_point(constructor:Rectangle_zss)
}
Rectangle_zss::Rectangle_zss(const Rectangle_zss& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      _internal_metadata_(nullptr),
      _has_bits_(from._has_bits_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ...
  // @@protoc_insertion_point(copy_constructor:Rectangle_zss)
}

void Rectangle_zss::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_Rectangle_zss_zss_5fdebug_2eproto.base);
...
Rectangle_zss::~Rectangle_zss() {
  // @@protoc_insertion_point(destructor:Rectangle_zss)
  SharedDtor();
}

void Rectangle_zss::SharedDtor() {
  if (this != internal_default_instance()) delete point1_;
  if (this != internal_default_instance()) delete point2_;
}

void Rectangle_zss::SetCachedSize(int size) const {
  _cached_size_.Set(size);
}
const Rectangle_zss& Rectangle_zss::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Rectangle_zss_zss_5fdebug_2eproto.base);
  return *internal_default_instance();
}


void Rectangle_zss::Clear() {
// @@protoc_insertion_point(message_clear_start:Rectangle_zss)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
const char* Rectangle_zss::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  while (!ctx->Done(&ptr)) {
    ::PROTOBUF_NAMESPACE_ID::uint32 tag;
...
#else  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER
bool Rectangle_zss::MergePartialFromCodedStream(
    ::PROTOBUF_NAMESPACE_ID::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!PROTOBUF_PREDICT_TRUE(EXPRESSION)) goto failure
  ::PROTOBUF_NAMESPACE_ID::uint32 tag;
  // @@protoc_insertion_point(parse_start:Rectangle_zss)
  for (;;) {
    ::std::pair<::PROTOBUF_NAMESPACE_ID::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:Rectangle_zss)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:Rectangle_zss)
  return false;
#undef DO_
}
#endif  // GOOGLE_PROTOBUF_ENABLE_EXPERIMENTAL_PARSER

void Rectangle_zss::SerializeWithCachedSizes(
    ::PROTOBUF_NAMESPACE_ID::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:Rectangle_zss)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:Rectangle_zss)
}

::PROTOBUF_NAMESPACE_ID::uint8* Rectangle_zss::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:Rectangle_zss)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Rectangle_zss)
  return target;
}

size_t Rectangle_zss::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:Rectangle_zss)
  size_t total_size = 0;
...
size_t Rectangle_zss::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Rectangle_zss)
  size_t total_size = 0;
...
void Rectangle_zss::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:Rectangle_zss)
  GOOGLE_DCHECK_NE(&from, this);
  const Rectangle_zss* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Rectangle_zss>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:Rectangle_zss)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:Rectangle_zss)
    MergeFrom(*source);
  }
}

void Rectangle_zss::MergeFrom(const Rectangle_zss& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:Rectangle_zss)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void Rectangle_zss::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:Rectangle_zss)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void Rectangle_zss::CopyFrom(const Rectangle_zss& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Rectangle_zss)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool Rectangle_zss::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000003) != 0x00000003) return false;
  if (has_point1()) {
...
void Rectangle_zss::InternalSwap(Rectangle_zss* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  swap(_has_bits_[0], other->_has_bits_[0]);
...
::PROTOBUF_NAMESPACE_ID::Metadata Rectangle_zss::GetMetadata() const {
  return GetMetadataStatic();
}
...
void Debug_Arc::InitAsDefaultInstance() {
  ::_Debug_Arc_default_instance_._instance.get_mutable()->rectangle_ = const_cast< ::Rectangle_zss*>(
      ::Rectangle_zss::internal_default_instance());
}
class Debug_Arc::_Internal {
 public:
  using HasBits = decltype(std::declval<Debug_Arc>()._has_bits_);
  static const ::Rectangle_zss& rectangle(const Debug_Arc* msg);
...
Debug_Arc::Debug_Arc(const Debug_Arc& from)
  ...
  if (from.has_rectangle()) {
    rectangle_ = new ::Rectangle_zss(*from.rectangle_);
  } else {
    rectangle_ = nullptr;
  }
...
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  ...
  while (!ctx->Done(&ptr)) {
    ...
    CHK_(ptr);
    switch (tag >> 3) {
      // required .Rectangle_zss rectangle = 1;
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
...
// @@protoc_insertion_point(class_specific_merge_from_start:Debug_Arc)
  ...
  if (cached_has_bits & 0x0000000fu) {
    if (cached_has_bits & 0x00000001u) {
      mutable_rectangle()->::Rectangle_zss::MergeFrom(from.rectangle());
    }
    if (cached_has_bits & 0x00000002u) {
      start_ = from.start_;
    }
...
template<> PROTOBUF_NOINLINE ::Rectangle_zss* Arena::CreateMaybeMessage< ::Rectangle_zss >(Arena* arena) {
  return Arena::CreateInternal< ::Rectangle_zss >(arena);
}
