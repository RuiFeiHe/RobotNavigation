...
extern Rectangle_zssDefaultTypeInternal _Rectangle_zss_default_instance_;
PROTOBUF_NAMESPACE_OPEN
...
template<> ::Rectangle_zss* Arena::CreateMaybeMessage<::Rectangle_zss>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
class Rectangle_zss :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Rectangle_zss) */ {
 public:
  Rectangle_zss();
  virtual ~Rectangle_zss();

  Rectangle_zss(const Rectangle_zss& from);
  Rectangle_zss(Rectangle_zss&& from) noexcept
    : Rectangle_zss() {
    *this = ::std::move(from);
  }

  inline Rectangle_zss& operator=(const Rectangle_zss& from) {
    CopyFrom(from);
    return *this;
  }
  inline Rectangle_zss& operator=(Rectangle_zss&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  static const Rectangle_zss& default_instance();

  static void InitAsDefaultInstance();  // FOR INTERNAL USE ONLY
  static inline const Rectangle_zss* internal_default_instance() {
    return reinterpret_cast<const Rectangle_zss*>(
               &_Rectangle_zss_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    1;

  friend void swap(Rectangle_zss& a, Rectangle_zss& b) {
    a.Swap(&b);
  }
  inline void Swap(Rectangle_zss* other) {
    if (other == this) return;
    InternalSwap(other);
  }
  ...
  inline Rectangle_zss* New() const final {
    return CreateMaybeMessage<Rectangle_zss>(nullptr);
  }

  Rectangle_zss* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<Rectangle_zss>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void CopyFrom(const Rectangle_zss& from);
  void MergeFrom(const Rectangle_zss& from);
  PROTOBUF_ATTRIBUTE_REINITIALIZES void Clear() final;
  bool IsInitialized() const final;
  ...
  inline void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Rectangle_zss* other);
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Rectangle_zss";
  }
  private:
  inline ::PROTOBUF_NAMESPACE_ID::Arena* GetArenaNoVirtual() const {
    return nullptr;
  ...
  // @@protoc_insertion_point(class_scope:Rectangle_zss)
 private:
  class _Internal;
...
class Debug_Arc :
 ...
 public:
  ...
  const ::Rectangle_zss& rectangle() const;
  ::Rectangle_zss* release_rectangle();
  ::Rectangle_zss* mutable_rectangle();
  void set_allocated_rectangle(::Rectangle_zss* rectangle);
...
// required .Point point1 = 1;
inline bool Rectangle_zss::has_point1() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void Rectangle_zss::clear_point1() {
  if (point1_ != nullptr) point1_->Clear();
  _has_bits_[0] &= ~0x00000001u;
}
inline const ::Point& Rectangle_zss::point1() const {
  const ::Point* p = point1_;
  // @@protoc_insertion_point(field_get:Rectangle_zss.point1)
  return p != nullptr ? *p : *reinterpret_cast<const ::Point*>(
      &::_Point_default_instance_);
}
inline ::Point* Rectangle_zss::release_point1() {
  // @@protoc_insertion_point(field_release:Rectangle_zss.point1)
  _has_bits_[0] &= ~0x00000001u;
  ::Point* temp = point1_;
  point1_ = nullptr;
  return temp;
}
inline ::Point* Rectangle_zss::mutable_point1() {
  _has_bits_[0] |= 0x00000001u;
  if (point1_ == nullptr) {
    auto* p = CreateMaybeMessage<::Point>(GetArenaNoVirtual());
    point1_ = p;
  }
  // @@protoc_insertion_point(field_mutable:Rectangle_zss.point1)
  return point1_;
}
inline void Rectangle_zss::set_allocated_point1(::Point* point1) {
  ...
  point1_ = point1;
  // @@protoc_insertion_point(field_set_allocated:Rectangle_zss.point1)
}

// required .Point point2 = 2;
inline bool Rectangle_zss::has_point2() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void Rectangle_zss::clear_point2() {
  if (point2_ != nullptr) point2_->Clear();
  _has_bits_[0] &= ~0x00000002u;
}
inline const ::Point& Rectangle_zss::point2() const {
  const ::Point* p = point2_;
  // @@protoc_insertion_point(field_get:Rectangle_zss.point2)
  return p != nullptr ? *p : *reinterpret_cast<const ::Point*>(
      &::_Point_default_instance_);
}
inline ::Point* Rectangle_zss::release_point2() {
  // @@protoc_insertion_point(field_release:Rectangle_zss.point2)
  _has_bits_[0] &= ~0x00000002u;
  ::Point* temp = point2_;
  point2_ = nullptr;
  return temp;
}
inline ::Point* Rectangle_zss::mutable_point2() {
  _has_bits_[0] |= 0x00000002u;
  if (point2_ == nullptr) {
    auto* p = CreateMaybeMessage<::Point>(GetArenaNoVirtual());
    point2_ = p;
  }
  // @@protoc_insertion_point(field_mutable:Rectangle_zss.point2)
  return point2_;
}
inline void Rectangle_zss::set_allocated_point2(::Point* point2) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete point2_;
  }
  ...
  point2_ = point2;
  // @@protoc_insertion_point(field_set_allocated:Rectangle_zss.point2)
}
...
inline const ::Rectangle_zss& Debug_Arc::rectangle() const {
  const ::Rectangle_zss* p = rectangle_;
  // @@protoc_insertion_point(field_get:Debug_Arc.rectangle)
  return p != nullptr ? *p : *reinterpret_cast<const ::Rectangle_zss*>(
      &::_Rectangle_zss_default_instance_);
}
inline ::Rectangle_zss* Debug_Arc::release_rectangle() {
  // @@protoc_insertion_point(field_release:Debug_Arc.rectangle)
  _has_bits_[0] &= ~0x00000001u;
  ::Rectangle_zss* temp = rectangle_;
  rectangle_ = nullptr;
  return temp;
}
inline ::Rectangle_zss* Debug_Arc::mutable_rectangle() {
  _has_bits_[0] |= 0x00000001u;
  if (rectangle_ == nullptr) {
    auto* p = CreateMaybeMessage<::Rectangle_zss>(GetArenaNoVirtual());
    rectangle_ = p;
  }
  // @@protoc_insertion_point(field_mutable:Debug_Arc.rectangle)
  return rectangle_;
}
inline void Debug_Arc::set_allocated_rectangle(::Rectangle_zss* rectangle) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete rectangle_;
  }
